			...
			<div class="findbar hidden doorHanger" id="findbar">
				...
				<div id="findbarOptionsTwoContainer">
					<input type="checkbox" id="findEntireWord" class="toolbarField"
						tabindex="96"> <label for="findEntireWord"
						class="toolbarLabel" data-l10n-id="find_entire_word_label">Whole
						words</label> <span id="findResultsCount" class="toolbarLabel hidden"></span>
				</div>
		...
		<div id="overlayContainer" class="hidden">
			...
			<div id="documentPropertiesOverlay" class="container hidden">
				<div class="dialog">
					...
					<div class="separator"></div>
					<div class="row">
						<span data-l10n-id="document_properties_linearized">Fast
							Web View:</span>
