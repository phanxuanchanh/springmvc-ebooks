...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Trang quản trị/Chi tiết nhà xuất
		bản</h1>
...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary">Chi tiết nhà xuất
			bản "${ publishingHouse.name }"</h6>
	</div>
	<div class="card-body">
	...
	<div class="card-footer">
		<a class="btn btn-primary"
			...
			href="<c:url value="/quan-tri/chinh-sua-nha-xuat-ban/${ publishingHouse.ID }"></c:url>">Chỉnh
			sửa</a>
	</div>
</div>