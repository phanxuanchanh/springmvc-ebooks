							...
							<thead>
								<tr role="row">
									<th class="sorting" tabindex="0" aria-controls="dataTable"
										rowspan="1" colspan="1" aria-sort="ascending">ID sách</th>
									<th class="sorting" tabindex="0" aria-controls="dataTable"
										rowspan="1" colspan="1" aria-sort="ascending">Tên sách</th>
									<th>Công cụ</th>
								</tr>
							</thead>
							<tfoot>
									...
									<tr role="row">
										...
										<td><a
											href="<c:url value="/quan-tri/chinh-sua-sach/${ item.Id }"></c:url>">Chỉnh
												sửa</a> | <a
											href="<c:url value="/quan-tri/chi-tiet-sach/${ item.Id }"></c:url>">Xem
												chi tiết</a> | <a
											href="<c:url value="/quan-tri/xoa-sach/${ item.Id }"></c:url>">Xóa</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
